...
def parse_args():
    ...
    parser.add_argument('--log_dir', type=str, default='pointnet2_att_cra', help='Log path [default: None]')
        ...
        with torch.no_grad():
            ...
            for l in range(NUM_CLASSES):
                iou_per_class_str += 'class %s weight: %.3f, IoU: %.3f \n' % (
                    seg_label_to_cat[l] + ' ' * (14+1 - len(seg_label_to_cat[l])), labelweights[l - 1],
